...
#include "velox/common/memory/subOp/include/enhanced_hash_agg/EnhancedHashTable.h"
...
EnhancedHashTable<ignoreNullKeys>::EnhancedHashTable(
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::storeKeys(
    HashLookup& lookup,
    vector_size_t row) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::storeRowPointer(
    uint64_t index,
    uint64_t hash,
    char* row) {
...
template <bool ignoreNullKeys>
char* EnhancedHashTable<ignoreNullKeys>::insertEntry(
    HashLookup& lookup,
    uint64_t index,
    vector_size_t row) {
...
template <bool ignoreNullKeys>
char* EnhancedHashTable<ignoreNullKeys>::insertEntryforSVE(
    HashLookup& lookup,
    uint64_t index,
    vector_size_t row) {
  char* group = rows_->newRow();
...
template <bool ignoreNullKeys>
bool EnhancedHashTable<ignoreNullKeys>::compareKeys(
    const char* group,
    HashLookup& lookup,
    vector_size_t row) {
...
FOLLY_ALWAYS_INLINE void EnhancedHashTable<ignoreNullKeys>::fullProbe(
    HashLookup& lookup,
    ProbeState& state,
    bool extraCheck) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::groupNormalizedKeyProbeSVE(HashLookup& lookup) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::groupProbe(
    HashLookup& lookup,
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::groupNormalizedKeyProbeScalar(
    HashLookup& lookup) {
  // TODO scalar2
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::groupNormalizedKeyProbe(HashLookup& lookup) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::arrayGroupProbe(HashLookup& lookup) {
  VELOX_DCHECK(!lookup.hashes.empty());
  VELOX_DCHECK(!lookup.hits.empty());
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::joinProbe(HashLookup& lookup) {
  incrementProbes(lookup.rows.size());
  if (hashMode_ == HashMode::kArray) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::arrayJoinProbe(HashLookup& lookup) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::joinNormalizedKeyProbe(HashLookup& lookup) {
  int32_t probeIndex = 0;
  int32_t numProbes = lookup.rows.size();
  const vector_size_t* rows = lookup.rows.data();
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::allocateTables(
    uint64_t size,
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::clear(bool freeTable) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::checkSize(
    int32_t numNew,
...
template <bool ignoreNullKeys>
bool EnhancedHashTable<ignoreNullKeys>::hashRows(
...
template <bool ignoreNullKeys>
bool EnhancedHashTable<ignoreNullKeys>::canApplyParallelJoinBuild() const {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::parallelJoinBuild() {
  process::TraceContext trace("EnhancedHashTable::parallelJoinBuild");
  TestValue::adjust(
      "facebook::velox::exec::EnhancedHashTable::parallelJoinBuild", rows_->pool());
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::partitionRows(
    EnhancedHashTable<ignoreNullKeys>& subtable,
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::buildJoinPartition(
    uint8_t partition,
...
template <bool ignoreNullKeys>
bool EnhancedHashTable<ignoreNullKeys>::insertBatch(
    char** groups,
    int32_t numGroups,
    raw_vector<uint64_t>& hashes,
    bool initNormalizedKeys) {
...
template <bool ignoreNullKeys>
FOLLY_ALWAYS_INLINE uint64_t* EnhancedHashTable<ignoreNullKeys>::getKeyPtr() {
  return reinterpret_cast<uint64_t*>(table_);
}

template <bool ignoreNullKeys>
FOLLY_ALWAYS_INLINE char** EnhancedHashTable<ignoreNullKeys>::getValuePtr() {
  return reinterpret_cast<char**>(table_ + capacity_);
}

template <bool ignoreNullKeys>
FOLLY_ALWAYS_INLINE uint8_t* EnhancedHashTable<ignoreNullKeys>::getTagPtr() {
  return reinterpret_cast<uint8_t*>(table_ + 2 * capacity_);
}

template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::insertForGroupBy(
    char** groups,
    uint64_t* hashes,
    int32_t numGroups) {
  if (hashMode_ == HashMode::kArray) {
...
template <bool ignoreNullKeys>
bool EnhancedHashTable<ignoreNullKeys>::arrayPushRow(
    RowContainer* rows,
    char* row,
    int32_t index,
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::pushNext(
    RowContainer* rows,
    char* row,
    char* next,
    HashStringAllocator* allocator) {
...
FOLLY_ALWAYS_INLINE void EnhancedHashTable<ignoreNullKeys>::buildFullProbe(
    RowContainer* rows,
    ProbeState& state,
    uint64_t hash,
    char* inserted,
...
template <bool ignoreNullKeys>
template <bool isNormailizedKeyMode>
FOLLY_ALWAYS_INLINE void EnhancedHashTable<ignoreNullKeys>::insertForJoinWithPrefetch(
    RowContainer* rows,
    char** groups,
    uint64_t* hashes,
    int32_t numGroups,
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::insertForJoin(
    RowContainer* rows,
    char** groups,
    uint64_t* hashes,
    int32_t numGroups,
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::rehash(
    bool initNormalizedKeys,
    int8_t spillInputStartPartitionBit) {
  ++numRehashes_;
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::setHashMode(
    HashMode mode,
    int32_t numNew,
    int8_t spillInputStartPartitionBit) {
  VELOX_CHECK_NE(hashMode_, HashMode::kHash);
  TestValue::adjust("facebook::velox::exec::EnhancedHashTable::setHashMode", &mode);
...
template <bool ignoreNullKeys>
bool EnhancedHashTable<ignoreNullKeys>::analyze() {
  constexpr int32_t kHashBatchSize = 1024;
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::enableRangeWhereCan(
...
template <bool ignoreNullKeys>
uint64_t EnhancedHashTable<ignoreNullKeys>::setHasherMode(
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::clearUseRange(std::vector<bool>& useRange) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::decideHashMode(
    int32_t numNew,
    int8_t spillInputStartPartitionBit,
...
template <bool ignoreNullKeys>
std::vector<RowContainer*> EnhancedHashTable<ignoreNullKeys>::allRows() const {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::checkHashBitsOverlap(
    int8_t spillInputStartPartitionBit) {
...
template <bool ignoreNullKeys>
std::string EnhancedHashTable<ignoreNullKeys>::toString() {
  std::stringstream out;
  out << "[EnhancedHashTable keys: " << hashers_.size()
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::prepareJoinTable(
  ...
  for (auto& table : tables) {
    otherTables_.emplace_back(
        std::unique_ptr<EnhancedHashTable<ignoreNullKeys>>(
            dynamic_cast<EnhancedHashTable<ignoreNullKeys>*>(table.release())));
  }
...
template <bool ignoreNullKeys>
inline uint64_t EnhancedHashTable<ignoreNullKeys>::joinProjectedVarColumnsSize(
...
template <bool ignoreNullKeys>
int32_t EnhancedHashTable<ignoreNullKeys>::listJoinResults(
...
template <bool ignoreNullKeys>
int32_t EnhancedHashTable<ignoreNullKeys>::listJoinResultsFastPath(
    JoinResultIterator& iter,
    bool includeMisses,
    folly::Range<vector_size_t*> inputRows,
    folly::Range<char**> hits,
...
int32_t EnhancedHashTable<ignoreNullKeys>::listRows(
    RowsIterator* iter,
    int32_t maxRows,
    uint64_t maxBytes,
    char** rows) {
...
template <bool ignoreNullKeys>
int32_t EnhancedHashTable<ignoreNullKeys>::listNotProbedRows(
    RowsIterator* iter,
    int32_t maxRows,
    uint64_t maxBytes,
    char** rows) {
...
template <bool ignoreNullKeys>
int32_t EnhancedHashTable<ignoreNullKeys>::listProbedRows(
    RowsIterator* iter,
    int32_t maxRows,
    uint64_t maxBytes,
    char** rows) {
...
template <bool ignoreNullKeys>
int32_t EnhancedHashTable<ignoreNullKeys>::listAllRows(
    RowsIterator* iter,
    int32_t maxRows,
    uint64_t maxBytes,
    char** rows) {
...
template <>
int32_t EnhancedHashTable<false>::listNullKeyRows(
...
template <>
int32_t
EnhancedHashTable<true>::listNullKeyRows(NullKeyRowsIterator*, int32_t, char**) {
  VELOX_UNREACHABLE();
}

template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::erase(folly::Range<char**> rows) {
  auto numRows = rows.size();
  raw_vector<uint64_t> hashes;
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::eraseWithHashes(
    folly::Range<char**> rows,
    uint64_t* hashes) {
  auto numRows = rows.size();
  if (hashMode_ == HashMode::kArray) {
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::checkConsistency() const {
...
template class EnhancedHashTable<true>;
template class EnhancedHashTable<false>;
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::prepareForGroupProbe(
    HashLookup& lookup,
...
template <bool ignoreNullKeys>
void EnhancedHashTable<ignoreNullKeys>::prepareForJoinProbe(
    HashLookup& lookup,
    const RowVectorPtr& input,
    SelectivityVector& rows,
