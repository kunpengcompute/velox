...
#include "EnhancedDecodedVector.h"
...
class EnhancedSumAggregateBase
 ...
 public:
  explicit EnhancedSumAggregateBase(TypePtr resultType) : BaseAggregate(resultType) {}
...
#define UNLIKELY(x) (__builtin_expect((x), 0))
      ...
      if (svptest_any(svptrue_b16(), mask00)) {
        ...
        if (svptest_any(svptrue_b32(), mask10)) {
          ...
          if (svptest_any(svptrue_b64(), mask20)) {
            ...
            svint64_t tmpResult0 = loadGatherResult(ptr, mask20, exec::Aggregate::offset_);
            tmpResult0 = svadd_m(mask20, tmpResult0, tmpValue0);
            storeScatterResult(ptr, mask20, tmpResult0, exec::Aggregate::offset_);
          }
          ...
          if (svptest_any(svptrue_b64(), mask21)) {
            ...
            svint64_t tmpResult1 = loadGatherResult(ptr, mask21, exec::Aggregate::offset_);
            tmpResult1 = svadd_m(mask21, tmpResult1, tmpValue1);
            storeScatterResult(ptr, mask21, tmpResult1, exec::Aggregate::offset_);
          }
        }
        ...
        if (svptest_any(svptrue_b32(), mask11)) {
          ...
          if (svptest_any(svptrue_b64(), mask22)) {
            ...
            svint64_t tmpResult2 = loadGatherResult(ptr, mask22, exec::Aggregate::offset_);
            tmpResult2 = svadd_m(mask22, tmpResult2, tmpValue2);
            storeScatterResult(ptr, mask22, tmpResult2, exec::Aggregate::offset_);
          }
          ...
          if (svptest_any(svptrue_b64(), mask23)) {
            ...
            svint64_t tmpResult3 = loadGatherResult(ptr, mask23, exec::Aggregate::offset_);
            tmpResult3 = svadd_m(mask23, tmpResult3, tmpValue3);
            storeScatterResult(ptr, mask23, tmpResult3, exec::Aggregate::offset_);
          }
        }
      }
      ...
      if (svptest_any(svptrue_b16(), mask01)) {
        ...
        if (svptest_any(svptrue_b32(), mask12)) {
          if (svptest_any(svptrue_b64(), mask24)) {
            ...
            svint64_t tmpResult4 = loadGatherResult(ptr, mask24, exec::Aggregate::offset_);
            tmpResult4 = svadd_m(mask24, tmpResult4, tmpValue4);
            storeScatterResult(ptr, mask24, tmpResult4, exec::Aggregate::offset_);
          }
          ...
          if (svptest_any(svptrue_b64(), mask25)) {
            ...
            svint64_t tmpResult5 = loadGatherResult(ptr, mask25, exec::Aggregate::offset_);
            tmpResult5 = svadd_m(mask25, tmpResult5, tmpValue5);
            storeScatterResult(ptr, mask25, tmpResult5, exec::Aggregate::offset_);
          }
        }
        ...
        if (svptest_any(svptrue_b32(), mask13)) {
          ...
          if (svptest_any(svptrue_b64(), mask26)) {
            ...
            svint64_t tmpResult6 = loadGatherResult(ptr, mask26, exec::Aggregate::offset_);
            tmpResult6 = svadd_m(mask26, tmpResult6, tmpValue6);
            storeScatterResult(ptr, mask26, tmpResult6, exec::Aggregate::offset_);
          }
          ...
          if (svptest_any(svptrue_b64(), mask27)) {
            ...
            svint64_t tmpResult7 = loadGatherResult(ptr, mask27, exec::Aggregate::offset_);
            tmpResult7 = svadd_m(mask27, tmpResult7, tmpValue7);
            storeScatterResult(ptr, mask27, tmpResult7, exec::Aggregate::offset_);
          }
        }
      }
    }
  ...
  void updateGroups(
    ...
    uint64_t* bitmask1 = const_cast<uint64_t*>(rows.allBits()); // 使用SelectivityVector原生自带的函数
    // decode.bits
    ...
    vector_size_t begin = rows.begin(); // 使用SelectivityVector原生自带的函数
    // vector_size_t end = rows.getEnd();
    vector_size_t end = rows.end(); // 使用SelectivityVector原生自带的函数
  ...
  void updateInternal(
    ...
    if (exec::Aggregate::numNulls_) {
      EnhancedDecodedVector decoded(*arg, rows, !mayPushdown);
